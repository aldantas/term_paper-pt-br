...
\begin{figure}[h]
	...
	\centering
	\includegraphics[scale=0.6]{../images/conductivity-humidity.jpg}
	\hspace{\linewidth}
...
\begin{figure}[h]
	...
	\centering
	\includegraphics[scale=0.3]{../images/soil_moisture.jpg}
	\hspace{\linewidth}
	Fonte: https://www.sparkfun.com
...
\subsubsection{Qual utilizar}
Realizar a medição de humidade absoluta do ar é uma técnica bastante utilizada em alguns utensílios, como
forno de microondas e secadoras de roupa, e em processos industriais, como máquinas de secagem e desidratação
de alimentos \cite{fontesII2005}.
