...
Considerando um casa de 10 cômodos, onde cada um possui um nó para temperatura e humidade, um para luz e uma
para relé. E ainda considerando um nó para sensor de gás na cozinha, cinco nós de sensor de humidade em
sólidos para plantas e um principal, a quantidade total de nós seria igual a 37.
...
atuadores são estão sendo levados em consideração pois são constantes, ou seja, independem da implementação
utilizada.
