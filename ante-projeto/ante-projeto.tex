...
\section{Identificação}
    ...
    \subsection{Palavras-chave}
        ...
        \begin{enumerate}
			...
			\item Comunicação por rádiofrequência
        \end{enumerate}
...
Quanto aos microcontroladores, foi optado a utilização dos modelos \texttt{AVR} da empresa \textit{Atmel Corporation}, pois
...
\begin{itemize}
	...
	\item Consumo - a quantidade de eletrecidade utilizada inferida através das especificações dos produtos;
	\item Código-fonte - a organização, legibilidade e desempenho do código-fonte.
\end{itemize}
