...
camadas física e de enlace do modelo ISO/OSI e é amplamente utilizado na construção de RSSFs. Além disso, serve como base para outros procolos que implementam camadas superiores, como por exemplo o protocolo ZigBee,
...
Porém, os módulos que implementam esses protocolos sofisticados possuem um preço relativamente maior em relação aos demais módulos com funcionamento mais básico, e acabam inflando o custo total da RSSF de acordo com o
número de nós da mesma.

Em paralelo à essas tecnologias, têm-se os módulos transmissores de rádio frequência nRF24l01+ da empresa \textit{Nordic Semicondutors}. Esses dispositivos possuem baixo custo monetário e possuem certas vantagens em relação aos módulos que
implementam apenas o padrão IEEE 802,.15.4
